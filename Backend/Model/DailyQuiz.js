...
const dailyQuizSchema = new mongoose.Schema({
    ...
    questions: [{
        ...
        options: { type: [String], required: true, validate: { validator: v => v.length === 4, message: 'Exactly 4 options required' } },
    ...
    leaderboardScore: { type: Number, default: 0, min: 0, max: 100 },
    parentQuizId: { type: mongoose.Schema.Types.ObjectId, ref: 'DailyQuiz' },
